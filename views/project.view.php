<div class="container card p-5">
    ...
    <div class="my-4">
        <button class="btn btn-primary"><a class="link-light" href="/project/index">Home</a> </button>
        <button class="btn btn-primary"><a class="link-light" href="/home">List of projects</a> </button>
